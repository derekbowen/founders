...
export const DEFAULT_FOOTER: SiteFooterSettings = {
  ...
  explore_links: [
    ...
    {
      label: "Pool Rental Near Me vs Swimply",
      href: "/p/swimply-alternative-vs-pool-rental-near-me",
    },
  ...
  host_links: [
    {
      label: "List Your Pool for Free",
      href: m("/l/draft/00000000-0000-0000-0000-000000000000/new/details"),
    },
  ...
  socials: [
    ...
    {
      label: "LinkedIn",
      href: "https://www.linkedin.com/company/poolrentalnearme",
      icon: "linkedin",
    },
