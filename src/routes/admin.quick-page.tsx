      ...
      <div className="flex items-center justify-between gap-4">
        <div>
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Type a title and what the page should be about. We&apos;ll write it on-brand and publish
            it at <code>/p/{`{slug}`}</code> instantly.
          </p>
        </div>
        <Link
          to="/admin/dashboard"
      ...
      >
        <div>
          ...
          <input
            ...
            required
          />
          <p className="mt-1 text-xs text-muted-foreground">The H1 and basis for the URL slug.</p>
        </div>
