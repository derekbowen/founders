  ...
  return (
    <AdminLayout>
      <div className="mb-6">
        ...
        <h1 className="mt-2 text-3xl font-bold tracking-tight">City hero image backfill</h1>
        <p className="mt-2 text-muted-foreground">
          Scrapes the source page for each city and saves the unique hero into the database. Admin
          only.
        </p>
      </div>
