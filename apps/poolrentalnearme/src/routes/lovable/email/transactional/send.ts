...
// Sender domain — overridable via env so we can flip the brand
// (poolrentalnearme.online → notify.founders.click) without a code change.
// SENDER_DOMAIN is the verified Emailit sender subdomain FQDN.
const SENDER_DOMAIN = process.env.EMAILIT_SENDER_DOMAIN ?? "notify.poolrentalnearme.online";
// FROM_DOMAIN is the domain shown in the From: header (cosmetic only).
