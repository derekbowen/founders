...
const InternalLeadNotificationEmail = ({
  ...
  return (
    <Html lang="en" dir="ltr">
      <Head />
      <Preview>
        {formType}: {submitterEmail}
      </Preview>
      <Body style={main}>
        <Container style={container}>
          <Heading style={h1}>New {formType} submission</Heading>
          <Text style={text}>A new lead just came through. Details below.</Text>
          ...
          <Hr style={hr} />
          <Text style={footer}>Sent automatically by Pool Rental Near Me.</Text>
        </Container>
      </Body>
    </Html>
  );
