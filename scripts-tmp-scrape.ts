...
const TOP_SLUGS = [
  ...
  "insurance-guide-for-pool-owners",
  "host-poolside-movie-night",
  "host-advocacy-florida",
  "earthquakes-and-inground-pools-guide",
  "dive-into-the-seventies-the-legendary-era-of-1970s-pool-parties",
  "host-advocacy-alabama",
  "everything-you-need-to-know-about-pool-alarms",
  "bestpoolsjurupavalleyca",
  "host-advocacy-new-jersey",
  "host-advocacy-georgia",
  "host-advocacy-california",
  "guide-to-graduation-party-pool-rental-mansfield-oh",
  "conviertete-en-anfitrion-de-piscina-tampa-fl",
  "allowing-nudity-at-your-pool",
  "about",
  "the-evolution-and-rise-of-pool-toys-a-journey-through-summer-fun",
];
...
async function processSlug(slug: string) {
  ...
  const canonical = rows.find((r: any) => r.url_path === `/p/${slug}`) ?? rows[0];
